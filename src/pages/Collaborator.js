          ...
          <Row around="xs">
            <Col xs={12} sm={6} md={4} lg={4}>
              ...
              <div className="square">
                ...
                <div className="content">
                  <img src={ReactLogo} alt="kk" className="skillLogo" />
                  <h2>React.js</h2>
                </div>
              </div>
            </Col>
            <Col xs={12} sm={6} md={4} lg={4}>
              <div className="square">
                ...
                <span></span>
                <div className="content">
                  <img src={MongoLogo} alt="kk" className="skillLogo" />
                  <h2>mongodb</h2>
                </div>
              </div>
            </Col>
            ...
            <Col xs={12} sm={6} md={4} lg={4}>
              <div className="square">
                ...
                <span></span>
                <div className="content">
                  <img src={NodeLogo} alt="kk" className="skillLogo" />
                  <h2>Node.js</h2>
                </div>
              </div>
            </Col>
          ...
          <Row around="xs" className="row2">
            <Col xs={12} sm={6} md={4} lg={4}>
              ...
              <div className="square">
                ...
                <span></span>
                <div className="content">
                  <img src={StaticLOgo} alt="kk" className="skillLogo" />
            ...
            <Col xs={12} sm={6} md={4} lg={4}>
              <div className="square">
                ...
                <span></span>
                <div className="content">
                  <img src={GraphicsLogo} alt="kk" className="skillLogo" />
            ...
            <Col xs={12} sm={6} md={4} lg={4}>
              <div className="square">
                ...
                <span></span>
                <div className="content">
                  <img src={VideoEditor} alt="kk" className="skillLogo" />
                  <h2>Video Editor</h2>
                </div>
              </div>
            </Col>
